...
const Home = () => {
	...
	return (
		<div style={{ maxWidth: 500, flex: 1 }}>
			...
			<Card>
				<p>
					Hi! we are Snapshot committee from RC team! Many students
					are spending a lot of time at home due to the COVID-19
					pandemic. If you have your own good know-how to soothe
					boredom, please share it with us!
				</p>
				<p>
					<b>🎬Categories</b>
				</p>
